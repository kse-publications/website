...
{
    public static Publisher MapToPublisher(this Page page)
    {
    ...
    public static Publication MapToPublication(this Page page,
        ICollection<Author> authors, ICollection<Publisher> publishers)
    {
    ...
    public static Author MapToAuthor(this Page page)
    {
        return new Author
        {
            Id = (int)((UniqueIdPropertyValue)page.Properties["ID"]).UniqueId.Number!.Value,
